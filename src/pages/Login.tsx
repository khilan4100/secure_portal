    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-slate-50 p-4">
      ...
      >
        <Card className="border-none shadow-2xl overflow-hidden">
          <div className="bg-navy p-12 text-center text-white relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                ...
                <Button 
                  type="submit"
                  variant="threeD"
                  className="w-full h-16 bg-navy hover:bg-slate-800 text-white shadow-xl transition-all flex items-center justify-center gap-3 text-lg font-black uppercase tracking-widest rounded-2xl"
                >
